...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        // Filtrer uniquement les personnes adultes (age >= 18)
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        // Filtrer les personnes dont le prénom est "first_10"
    ...
    public void test_filter_by_password() throws Exception {
        ...
        // Filtrer les personnes dont l'âge est > 49 et dont le hash du mot de passe correspond à passwordSha512Hex
